...
public class GUI extends Application {
   ...
   private AudioClip bgm; //background music audio identifier
	...
	public void start(Stage primaryStage) {
      ...
      bgm = new AudioClip(getClass().getResource("/application/bensound-acousticbreeze.WAV").toExternalForm()); 
      ...
      music.getItems().addAll(play, stop);
      ...
      MenuItem exit = new MenuItem("Exit");
		...
		menu.getMenus().addAll(file, music, help);
